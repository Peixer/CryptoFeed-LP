  ...
  const team = [
    {
      ...
      image:
        "https://demos.creative-tim.com/soft-ui-design-system/assets/img/team-4.jpg",
    },
    {
      name: "Maria Sephard",
      ...
      description:
        "Artist is a term applied to a person who engages in an activity deemed to be an art.",
      image:
        "https://demos.creative-tim.com/soft-ui-design-system/assets/img/ivana-square.jpg",
    },
    {
      name: "Rachel Marque",
      ...
      description:
        "Artist is a term applied to a person who engages in an activity deemed to be an art.",
      image:
        "https://demos.creative-tim.com/soft-ui-design-system/assets/img/kal-visuals-square.jpg",
    },
    {
      name: "Jordi Alves",
      ...
      description:
        "Artist is a term applied to a person who engages in an activity deemed to be an art.",
      image:
        "https://demos.creative-tim.com/soft-ui-design-system/assets/img/bruce-mars.jpg",
    },
  ];
  return (
    <section className="pb-20 pt-14 mb-32 m-6 " id="team">
